 ...
 *  	-o outputFileName.mat -l newFreqOffsets -s poolSwitchOnOff -r 300 testing this program
 *
 * OUTPUT:
 * outputFileName.mat
...
// Dimensions of CEST data
	...
	int status, statusFitParameters, statusMtPoolFit, statusNoe1PoolFit,
...
// MATLAB style array (no efficient memory management is a price for convenience)
	size_t idx1 = 0;
			...
			for (size_t j = 0; j < dim3; j++) {
				...
				for (size_t offsetNo = 0; offsetNo < NfrequencyOffsetOut;
					...
					fitMtPoolArray[l][k][j][offsetNo] =
							singlePoolFittedSpectrum[1][offsetNo];
					fitNoe1PoolArray[l][k][j][offsetNo] =
							singlePoolFittedSpectrum[2][offsetNo];
					fitNoe2PoolArray[l][k][j][offsetNo] =
							singlePoolFittedSpectrum[3][offsetNo];
					fitCrPoolArray[l][k][j][offsetNo] =
							singlePoolFittedSpectrum[4][offsetNo];
					fitAmidePoolArray[l][k][j][offsetNo] =
							singlePoolFittedSpectrum[5][offsetNo];
					fitWaterPoolArray[l][k][j][offsetNo] =
							singlePoolFittedSpectrum[6][offsetNo];
				}
			}
		}
	}
