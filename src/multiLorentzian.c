...
void usage(void) {
	char msg[256] =
			"Usage: ./dataFitting [-i] [inputFileName.mat] [-d] [inputCestData] [-k] [originalFreqOffsets] [-o] [outputFileName.mat] [-l] [newFreqOffsets [-s] [poolSwitchOnOff] [-r] [100] [my optional comments]";
	fprintf(stderr, "%s\n", msg);
	exit(1);
}
